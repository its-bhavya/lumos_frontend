...
export default function LandingPageClient() {
  ...
  return (
    <main className="flex h-full flex-col items-center justify-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-100 via-blue-200 to-blue-300 p-8 text-center" style={{'--tw-gradient-from': 'hsl(212, 100%, 92%)', '--tw-gradient-to': 'hsl(212, 100%, 87%)', '--tw-gradient-stops': 'var(--tw-gradient-from), var(--tw-gradient-to)'} as React.CSSProperties}>
